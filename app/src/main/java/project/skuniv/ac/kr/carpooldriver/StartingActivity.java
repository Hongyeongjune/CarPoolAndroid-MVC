...
public class StartingActivity extends AppCompatActivity
    ...
    private LatLng departureLatLng = null;
    private LatLng destinationLatLng = null;
    private String departureName = null;
    private String destinationName = null;
    private Button searchPolyLine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchPolyLine = (Button) findViewById(R.id.starting_button);

        /**
         * 참고 : https://webnautes.tistory.com/1249
         */

        // Initialize Places.
        Places.initialize(getApplicationContext(), "AIzaSyDguyiQABPWPG6K3j39dBwFKQJuqQ6M1-w");

// Create a new Places client instance.
        PlacesClient placesClient = Places.createClient(this);

        // Initialize the AutocompleteSupportFragment.
        AutocompleteSupportFragment autocompleteFragmentDeparture = (AutocompleteSupportFragment)
                getSupportFragmentManager().findFragmentById(R.id.autocomplete_fragment_departure);

// Specify the types of place data to return.
        autocompleteFragmentDeparture.setPlaceFields(Arrays.asList(Place.Field.ID, Place.Field.NAME, Place.Field.ADDRESS, Place.Field.LAT_LNG));

        autocompleteFragmentDeparture.setCountry("KR");
...
// Set up a PlaceSelectionListener to handle the response.
        autocompleteFragmentDeparture.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                departureName = new String();
                departureName = place.getName();

                departureAddress = new String();
...
// Specify the types of place data to return.
        ...
        autocompleteFragmentDestination.setCountry("KR");
...
// Set up a PlaceSelectionListener to handle the response.
        ...
        searchPolyLine.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(departureAddress != null && destinationAddress != null) {
                    Intent intent = new Intent(getApplicationContext(), SearchActivity.class);
                    intent.putExtra("departureAddress", departureAddress);
                    intent.putExtra("destinationAddress", destinationAddress);
                    intent.putExtra("departureLat", departureLatLng.latitude);
                    intent.putExtra("departureLng", departureLatLng.longitude);
        ...
        name = (TextView) navigation_header_view.findViewById(R.id.nav_header_name);
        id = (TextView) navigation_header_view.findViewById(R.id.nav_header_id);
